package com.milind.springbatchbillsetuptask.configuration;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.milind.springbatchbillsetuptask.domain.Bill;
import com.milind.springbatchbillsetuptask.domain.Usage;
import com.milind.springbatchbillsetuptask.processor.BillProcessor;
...
public class BillingConfiguration {
    ...
    @Value("${usage.file.name:classpath:data.json}")
    ...
    public ItemWriter<Bill> jdbcBillWriter(DataSource dataSource) {
        JdbcBatchItemWriter<Bill> writer = new JdbcBatchItemWriterBuilder<Bill>()
                ...
                .sql("INSERT INTO BILL_STATEMENTS (id, first_name, " +
                        ...
                        "(:id, :firstName, :lastName, :mins, :dataUsage, " +
                        ":billAmount)")
                .build();
        return writer;
    }
